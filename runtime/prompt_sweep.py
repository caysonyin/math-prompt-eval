...
from shared.io import resolve_api_config
from runtime.prompts import list_prompts
from runtime.run import _resolve_paths, main as run_main, build_arg_parser as run_build_arg_parser
...
def _run_single_prompt(
    ...
    """Run a single prompt via `runtime.run.main` and return its summary dict.
