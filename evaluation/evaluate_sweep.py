...
from evaluation.evaluate import build_llm_judge_config, print_score_summary
from shared.vendor import validate_results, write_validation_report
...
def _iter_result_files(sweep_dir: Path) -> List[Path]:
    ...
    (prompt / model / ts), matching the layout `runtime.run` writes.
    """
