...
exactly once at import time:
    ...
    # llm_math/prompts/my_prompt_v1.py
...
`llm_math.run` and the registry surfaced by `llm_math.prompts.list_prompts()`.
"""
...
from llm_math.prompts._base import PromptTemplate, _validate
