...
comparisons use `llm_math.compare`.
...
from llm_math.evaluate import build_llm_judge_config
from llm_math.vendor import validate_results
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    # LLM-judge surface — mirrors llm_math.evaluate.build_llm_judge_config.
